...
import ForgotPasswordWithTempPasswords from './ForgotPasswordWithTempPasswords';
...
const AuthContainer = ({ mode: initialMode }) => {
  ...
  useEffect(() => {
    const handleShowForgotPassword = () => {
      setMode('forgotPasswordWithTemp');
    };
    ...
    case 'forgotPasswordWithTemp':
      return (
        <div className="auth-container">
          ...
          />
          <div style={{ marginTop: '80px' }}>
            <ForgotPasswordWithTempPasswords
              onBackToLogin={() => setMode('login')}
              onLoginWithNewPassword={(newPassword) => {
